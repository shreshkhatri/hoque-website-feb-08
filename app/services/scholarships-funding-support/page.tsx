...
export const metadata: Metadata = {
  title: 'Scholarships & Funding Support for International Students | HOQUE',
  description: 'Access prestigious university scholarships, bursaries, and funding opportunities for international students. Our expert team helps you secure financial aid for your studies.',
