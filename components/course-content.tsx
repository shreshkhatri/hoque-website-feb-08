            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="flex flex-col gap-3">
                <Button asChild size="lg" className="w-full">
                  <Link href={`/application-form?course=${encodeURIComponent(course.name)}&university=${encodeURIComponent(course.universities?.name || '')}&level=${encodeURIComponent(course.program_level || '')}&intake=${encodeURIComponent(course.intake_months || '')}`}>
                    Apply Now
